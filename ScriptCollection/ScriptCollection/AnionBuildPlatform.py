...
class AnionBuildPlatform:
    ...
    def run(self) -> None:
        ...
        self.__sc.run_program(self.__sc.get_python_executable(),f"MergeToMain.py{merge_to_main_arguments}",scripts_folder,print_live_output=True)
        ...
        self.__sc.run_program(self.__sc.get_python_executable(),f"MergeToStable.py{merge_to_stable_arguments}",scripts_folder,print_live_output=True)
