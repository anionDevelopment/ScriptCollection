...
class TFCPS_CodeUnit_BuildCodeUnits:
    ...
    def run_prepare_script(self):
        ...
        if  os.path.isfile( os.path.join( self.sc.get_scriptcollection_configuration_folder(),"TFCPS","CustomPreCodeUnitBuildScript.py")):
            ...
            self.sc.run_program_argsasarray(self.sc.get_python_executable(),["CustomPreCodeUnitBuildScript.py"]+args, os.path.join( self.sc.get_scriptcollection_configuration_folder(),"TFCPS"),print_live_output=True)
        ...
        if  os.path.isfile( os.path.join(self.repository,"Other","Scripts","PrepareBuildCodeunits.py")):
            ...
            self.sc.run_program_argsasarray(self.sc.get_python_executable(),["PrepareBuildCodeunits.py"]+args, os.path.join(self.repository,"Other","Scripts"),print_live_output=True)
    ...
    def update_dependencies(self) -> None:
        ...
        if os.path.isfile(os.path.join(repository,"Other","Scripts","UpdateDependencies.py")):
            self.sc.run_program(self.sc.get_python_executable(),"UpdateDependencies.py",os.path.join(repository,"Other","Scripts"))
        ...
        for codeunit_name in codeunits:
            ...
            if self.tfcps_tools_general.codeunit_has_updatable_dependencies(os.path.join(codeunit_folder,f"{codeunit_name}.codeunit.xml")):
                self.sc.run_program(self.sc.get_python_executable(),"UpdateDependencies.py",os.path.join(codeunit_folder,"Other"))
